...
class LinkedList{
	protected:
		...
		Node<T> *first;
		int current_size;
		int MAX_SIZE; // LinkedList에 들어갈 수 있는 노드의 최대 갯수.
	public:
		//생성자, 초기화 
		LinkedList(){
			first = 0;
		...
		// 파생 클래스에서 오버라이딩될 함수 앞에 'virtual' 선언을 하여 가상함수임을 선언해야 합니다..!!
...
void LinkedList<T>::Insert(T element){
	...
	{
		cout << "LinkedList 혹은 Stack이 꽉 찼습니다. 더 이상 노드를 생성할 수 없으므로 프로그램을 종료하겠습니다..!!\n";
		exit(1);
	}	
